...
class RunnerConfig:
    ...
    def start_measurement(self, context: RunnerContext) -> None:
        ...
        if subject == "Sherlock":
            ...
            # usernames = "user1\nuser2\nuser3\nuser4"
            profiler_cmd = f'/home/sven/Downloads/EnergiBridge/target/release/energibridge ' \
                       f'--interval {sampling_interval} ' \
                       f'--output {context.run_dir / "energibridge.csv"} ' \
                       f'--summary ' \
                       f'python3 {script} "{arguments}"'
            ...
            profiler_cmd = f'/home/sven/Downloads/EnergiBridge/target/release/energibridge ' \
                       ...
                       f'--output {context.run_dir / "energibridge.csv"} ' \
                       f'--summary ' \
                       f'python3 {script} --prompts "{arguments}" ' \
    ...
    def populate_run_data(self, context: RunnerContext) -> Optional[Dict[str, Any]]:
        ...
        total_time = round(df['Delta'].sum(), 3)
